...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="page-title float-left mb-0"><?php echo app('translator')->getFromJson('labels.backend.testimonials.title'); ?></h3>
            ...
            <table id="myTable"
                ...
                <tr>
                    ...
                    <?php endif; ?>
                        ...
                        <th><?php echo app('translator')->getFromJson('labels.backend.testimonials.fields.name'); ?></th>
                    <th><?php echo app('translator')->getFromJson('labels.backend.testimonials.fields.occupation'); ?></th>
                    <th><?php echo app('translator')->getFromJson('labels.backend.testimonials.fields.content'); ?></th>
                    <th><?php echo app('translator')->getFromJson('labels.backend.testimonials.fields.status'); ?></th>
                    <?php if( request('show_deleted') == 1 ): ?>
