...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="page-title float-left mb-0"><?php echo app('translator')->getFromJson('labels.backend.blogs.edit'); ?></h3>
            <div class="float-right">
                <a href="<?php echo e(route('admin.blogs.index')); ?>"
                   class="btn btn-success"><?php echo app('translator')->getFromJson('labels.backend.blogs.view'); ?></a>
            </div>
        </div>
        <div class="card-body">
            <div class="row">
