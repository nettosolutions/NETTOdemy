...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="page-title d-inline"><?php echo app('translator')->getFromJson('labels.backend.coupons.create'); ?></h3>
            <div class="float-right">
                <a href="<?php echo e(route('admin.coupons.index')); ?>"
                   class="btn btn-success"><?php echo app('translator')->getFromJson('labels.backend.coupons.view'); ?></a>
        ...
        <div class="card-body">
            ...
            <div class="row form-group">
                ...
                <div class="col-md-10">
                    ...
                    <p class="mb-0"><?php echo app('translator')->getFromJson('labels.backend.coupons.type_note'); ?></p>
                </div><!--col-->
            </div>
            ...
            <div class="row form-group">
                ...
                <div class="col-md-10">
                    ...
                    <p class="mb-0"><?php echo app('translator')->getFromJson('labels.backend.coupons.amount_note'); ?></p>
            ...
            <div class="row form-group">
                ...
                <div class="col-md-10">
                    ...
                    <p class="mb-0"><?php echo app('translator')->getFromJson('labels.backend.coupons.per_user_limit_note'); ?></p>
