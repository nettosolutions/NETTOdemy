...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card">
        <div class="card-header">
                ...
                <h3 class="page-title d-inline"><?php echo app('translator')->getFromJson('labels.backend.reasons.title'); ?></h3>
        ...
        <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <div class="d-block">
                            <ul class="list-inline">
                                ...
                                |
                                <li class="list-inline-item">
                                    <a href="<?php echo e(route('admin.reasons.index')); ?>?show_deleted=1"
                        ...
                        <table id="myTable"
                            ...
                            <tr>
                                ...
                                <th><?php echo app('translator')->getFromJson('labels.backend.reasons.fields.title'); ?></th>
                                <th><?php echo app('translator')->getFromJson('labels.backend.reasons.fields.icon'); ?></th>
                                <th><?php echo app('translator')->getFromJson('labels.backend.reasons.fields.content'); ?></th>
                                <th><?php echo app('translator')->getFromJson('labels.backend.reasons.fields.status'); ?></th>
                                <?php if( request('show_deleted') == 1 ): ?>
            ...
            <hr>
            <h4><?php echo app('translator')->getFromJson('labels.backend.reasons.note'); ?></h4>
...
<?php $__env->startPush('after-scripts'); ?>
    <script>
        ...
        $(document).ready(function () {
            ...
            <?php if(request('show_deleted') != 1): ?>
            $('.actions').html('<a href="' + '<?php echo e(route('admin.reasons.mass_destroy')); ?>' + '" class="btn btn-xs btn-danger js-delete-selected" style="margin-top:0.755em;margin-left: 20px;">Delete selected</a>');
            <?php endif; ?>
            <?php endif; ?>
