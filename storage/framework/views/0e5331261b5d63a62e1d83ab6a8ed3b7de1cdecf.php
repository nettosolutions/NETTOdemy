...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col-sm-5">
                    <h3 class="page-title d-inline"><?php echo app('translator')->getFromJson('labels.backend.general_settings.contact.title'); ?></h3>
                </div>
            </div>
        </div>
...
<?php $__env->startPush('after-scripts'); ?>
    <script>
       ...
       <?php if(config('contact_data')): ?>
        var contact_data = "<?php echo e(config('contact_data')); ?>";
